...
const Project = () => {
  ...
  return (
    <section id='project' className='min-h-screen flex items-center justify-center bg-gradient-to-r bg-gray-900 py-16 px-6'>
      <div className='max-w-7xl mx-auto w-full'>
        ...
        <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-10'>
            {projects.map((project, index) => (
                <div 
                  key={index} 
                  className='bg-gray-950 rounded-lg shadow-[0px_0px_15px_5px_rgba(255,255,255,0.3)] hover:shadow-[0px_0px_20px_10px_rgba(255,255,255,0.5)] overflow-hidden transform transition-transform hover:scale-105'>
